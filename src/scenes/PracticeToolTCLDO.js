...
export class PracticeToolTCLDO extends Phaser.Scene {
  constructor() {
    // Se asigna una key para despues poder llamar a la escena
    super("PracticeToolTCLDO");
  }
  ...
  preload() {
    ...
    this.load.audio("SoundCorrect", "./public/Assets/SoundCorrect.wav");
    this.load.audio("SoundIncorrect", "./public/Assets/SoundIncorrect.wav");
    this.load.audio("SoundTrack", "./public/Assets/SoundTrack.wav");
    this.load.audio("CountDown", "./public/Assets/CountDown.wav");
    this.load.audio("StartSound", "./public/Assets/StartSound.wav");
  }
  ...
  create() {
    ...
    this.soundCorrect = this.sound.add("SoundCorrect", {
      loop: false,
      volume: 0.5,
    });
    this.soundIncorrect = this.sound.add("SoundIncorrect", {
      loop: false, 
      volume: 1,
    });
  ...
  BplayDown(level, button) {
    ...
    // Texto de cuenta regresiva antes de iniciar el juego
    let countdown = 3;
